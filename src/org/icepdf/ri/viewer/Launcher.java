...
/* Example code from ICESoft adapted to run from an application */
/* CUCFL:  adapted by the Champaign Urbana Community Fab Lab */
...
public class Launcher {
    ...
    */
     ...
     */
    public /*static*/ void run(String contentFile,
                            String contentURL,
